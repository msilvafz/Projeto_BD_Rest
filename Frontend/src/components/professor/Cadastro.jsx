...
const Cadastro = () => {
  ...
  const [newCurso, setNewCurso] = useState({ nome: '', descrição: '', preço: '', imagem: '', video: '', promoção:'' });
  ...
  const handleAdd = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:3000/cursos', newCurso);
      const addCursos = response.data;
      setCursos([...cursos, addCursos]);
      setNewCurso({ nome: '', descrição: '', preço: '', imagem: '', video: '', promoção:'' });
          ...
          <Card className="mt-5">
            <Card.Body>
              ...
              <Form onSubmit={handleAdd}>
                ...
                <Button variant="secondary" onClick={toggleAddForm} style={{ marginLeft: '10px' }}>
                  Cancelar
                </Button>
              </Form>
              ...
              {newCurso.imagem && (
                <div className="mt-4">
                  ...
                  <img src={newCurso.imagem} alt="Imagem do Curso" style={{ maxWidth: '100%', height: 'auto' }} />
                </div>
              )}
              {newCurso.video && (
                <div className="mt-4">
